...
namespace HotFlix.Persistence.DAL.Migrations
{
    ...
    [Migration("20250219194808_addhasdislikedtocommentstable")]
    partial class addhasdislikedtocommentstable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotFlix.Domain.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotFlix.Domain.Models.SeasonVideos", b =>
                {
                    ...
                    b.ToTable("SeasonVideos");
                });

            modelBuilder.Entity("HotFlix.Domain.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotFlix.Domain.PlanOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotFlix.Domain.Models.Review", b =>
                {
                    ...
                    b.HasOne("HotFlix.Domain.Models.Rating", "Ratings")
                        .WithMany()
            ...
            modelBuilder.Entity("HotFlix.Domain.PlanOrder", b =>
                {
                    b.HasOne("HotFlix.Domain.Models.PremiumPlan", "PremiumPlanPlan")
                        .WithMany()
                        .HasForeignKey("PremiumPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
